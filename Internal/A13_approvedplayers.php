...
if (mysql_num_rows($result) > 0) {
    ...
    while ($row = mysql_fetch_assoc($result)) {
        ...
        echo "<td><a style='display: inline-block; padding: 5px 10px; background-color: #e74c3c; color: #fff; text-decoration: none; border-radius: 5px;' href=A_UniversalController.php?Action=Rejected&TblName=player_reg&id=$id>Revoke</a></td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
