                  ...
                  <!-- <input type="hidden" name="email" data-form-email="true" value="nbakCZ2Fm5C8CH2z+HVR/Wcw+bNIoHE7Sk+BRKWdY7R69eDOHtL9bPWrxxvvdOkzQ+3JrINF1iqAYGUmGFysyb0fcPoZiB+B5kM0hh17HdKe0Rh+IlCXjoEyO8C0k9rh"> -->
                    ...
                    <div class="dragArea row">
                        <div class="col-md col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="name" placeholder="Full Name" data-form-field="name" class="form-control" value="" id="name-contact-form-3-u88IYzf3mX">
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn">
                            <input type="text" name="typeofaccount" value="Player" hidden>
                            <button type="submit" name="registerbtn" class="btn btn-primary display-7">Register Now</button>
                        </div>
                    </div>
                </form>
            </div>
